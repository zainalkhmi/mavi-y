...
type BindingSpec = readonly BindableValue[] | {
  [paramName: string]: BindableValue;
} /** Assumed to have binding index `1` */ | (SqlValue | boolean);
/**
...
type ExecOptions = {
  ...
  callback?: (row: SqlValue[] | {
    [columnName: string]: SqlValue;
  } | PreparedStatement | SqlValue, stmt: PreparedStatement) => void | false;
  /**
...
declare class Database {
  ...
  /**
     ...
     */
  selectObject(sql: FlexibleString, bind?: BindingSpec): {
    [columnName: string]: SqlValue;
  } | undefined;
  /**
     ...
     * {@link Database#exec}.
     */
  selectObjects(sql: FlexibleString, bind?: BindingSpec): {
    [columnName: string]: SqlValue;
  }[];
  /**
...
declare class SQLiteStruct {
  ...
  installMethod(methodsObject: {
    [methodName: string]: Function;
  }, applyArgcCheck?: boolean): this;
  /**
