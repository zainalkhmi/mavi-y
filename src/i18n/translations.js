...
export const translations = {
    en: {
        ...
        landing: {
            ...
            hero: {
                ...
                title: 'Engineering Intelligence<br />Accelerated by Vision.',
                highlight: 'Intelligence',
                subtitle: 'The premium industrial engineering toolkit for cycle time analysis, VR training, and motion intelligence. Get started today.',
                ctaPrimary: 'Start Free Demo',
                ctaSecondary: 'Learn More',
                ctaDownload: 'Download for Desktop (.exe)',
                ctaCloud: 'Cloud Access',
                ctaTrial: 'Start 30-Min Trial'
            },
            solutions: {
                title: 'Why Mavi?',
                oldWay: 'The Old Way',
                maviWay: 'The Mavi Way',
                old: {
                    stopwatch: {
                    ...
                    paper: {
                        ...
                        desc: 'Data trapped on paper, requiring manual data entry to Excel later.'
                    },
                    subjective: {
                ...
                mavi: {
                    video: {
                        ...
                        desc: 'Precise times captured automatically from video footage.'
                    },
                    digital: {
                        title: 'Digital & Instant',
                        desc: 'Data is instantly digitized. Generate reports and manuals in one click.'
                    },
                    standardized: {
            ...
            features: {
                ...
                manual: {
                    ...
                    desc: 'Turn analysis into training manuals. Import from Excel/Word or create from video steps.'
                },
                workflow: {
                    title: 'Drag & Drop Workflow',
                    desc: 'Visually reorder process elements to try new layouts without stopping the line.'
                },
                cloud: {
                    title: 'Cloud Sync',
                    desc: 'Collaborate with your team in real-time. Securely sync projects and manuals across devices.'
                }
            },
            how: {
                ...
                capture: {
                    title: 'Capture',
                    desc: 'Record your production line or upload existing video files directly to the platform.'
                },
                analyze: {
                    title: 'Analyze',
                ...
                improve: {
                    title: 'Improve',
                    desc: 'Use data-driven insights to balance lines, eliminate bottlenecks, and boost productivity.'
                }
            },
            audience: {
                ...
                pm: {
                    ...
                    desc: 'Get full visibility into your production lines. Identify bottlenecks instantly and track efficiency improvements over time.'
                },
                lc: {
                    title: 'Lean Consultants',
                    desc: 'Deliver value to your clients faster. Use Mavi to provide data-driven recommendations and impressive "Before/After" visual evidence.'
                }
            },
            faq: {
            ...
            cta: {
                ...
                desc: 'Join thousands of engineers saving time and improving efficiency with Mavi.',
            ...
            request: {
                title: 'Request License Key',
                desc: 'Need a professional license for your organization? Send us a request and our administrator will get back to you with a key.',
                benefit1: 'Lifetime access to all features',
                benefit2: 'Priority support and updates',
                deviceId: 'Device ID (Hardware Lock)',
                email: 'Email Address',
                notes: 'Notes (Optional)',
                notesPlaceholder: 'Tell us about your organization...',
                submit: 'Submit Request',
                sending: 'Sending...',
                successTitle: 'Request Sent!',
                successDesc: 'Our team will review your request and send the license key to your email.',
                offlineTitle: 'Request Cached!',
                offlineDesc: 'Connection failed. Request saved locally on this computer. Please notify admin manually or try again in a different browser.',
                back: 'Back'
            },
        },
        vsm: {
            ...
            clear: 'Clear',
            newVsm: 'New VSM',
            confirmDeleteNode: 'Delete selected symbol?',
            ...
            backToCanvas: 'Back to VSM',
            help: {
                mainTitle: 'Value Stream Mapping (MIFH)',
                addingSymbols: 'Adding Symbols',
                dragDrop: 'Drag symbols from the VSM Toolbox (right sidebar)',
                dropCanvas: 'Drop on canvas to add',
                ...
                autoArrow: 'Automatically creates arrow connections',
                keyboardShortcuts: 'Keyboard Shortcuts',
                saveLoadHeading: 'Save/Load Features',
                saveDesc: 'Download VSM as .mavi-vsm file',
                loadDesc: 'Load VSM from file',
                mergeReplace: 'Select mode: Replace (clear all) or Merge (combine)',
                ...
                timelineDesc: 'Auto-ladder at bottom shows Lead Time vs VA Time.',
                ...
                paramCT: 'CT (Cycle Time): Time to complete 1 unit (sec).',
                paramCO: 'CO (Changeover): Time setup for product change.',
                paramUptime: 'Uptime: % machine/tool availability.',
                paramYield: 'Yield: % good products (First Time Right).',
                inventoryNodeTitle: 'Inventory (Triangle)',
                inventoryNodeDesc: 'Material buildup between processes.',
                paramAmount: 'Amount: Physical quantity (pcs/kg).',
                paramTime: 'Time: Stock days = Stock / Daily Demand.',
                customerTitle: 'Customer / Supplier (Factory)',
                paramDemand: 'Demand: Customer orders per day.',
                paramTakt: 'Takt Time: Required pace = Available Time / Demand.'
            },
            simulation: {
            ...
            toolbox: {
                ...
                prodKanban: 'Prod. Kanban',
                wDrawKanban: 'W-Draw Kanban',
                signalKanban: 'Signal Kanban',
                goSee: 'Go See',
                buffer: 'Buffer',
                timelineMetrics: 'TIMELINE & METRICS',
                generalNotes: 'GENERAL / NOTES',
                stickyNote: 'Sticky Note / Text',
                customIcons: 'CUSTOM (MY ICONS)',
                uploadIcon: 'Upload Icon'
            },
            wizard: {
                title: 'MAGIC WIZARD',
                customerTitle: 'Customer Configuration',
                customerDesc: 'Define your customers and their demand requirements.',
                ...
                productionDesc: 'Enter sequential processes from Upstream (Supplier) to Downstream (Customer).',
                ...
                receivingDesc: 'Configure material receiving area before production.',
                useReceiving: 'Use Receiving Warehouse?',
                receivingInfo: 'Adds initial buffer stock after material arrival.',
                initialStock: 'Initial Stock (pcs)',
                internalTransport: 'Internal Transport Method',
                directMaterialInfo: 'Material is shipped directly from supplier to first process.',
                supplierTitle: 'Suppliers & Material',
                addSupplier: 'Add Supplier',
                useMaterialWh: 'Use Material WH (RM)',
                ...
                generateInfo: 'VSM will be laid out from Upstream (Supplier) to Downstream (Customer).',
                back: 'Back',
                next: 'Next',
            ...
            analysis: {
                ...
                epeiDesc: 'Add Customer (Demand) and Processes to calculate EPEI.',
                epeiResult: 'Your Current EPEI:',
                excellent: 'Excellent Flexibility!',
                overload: 'Capacity Overload!',
                highCO: 'Changeover Time Too High',
                recommendation: 'Recommendation:',
                smedAdvice: 'Perform SMED (Single Minute Exchange of Die) to reduce CO time to reach EPEI of 1 day or less.',
                healthyAdvice: 'Your process is very flexible. You can produce small batches to reduce supermarket levels.',
                yamazumiTitle: 'Workload Balance',
                yamazumiSubtitle: 'Yamazumi Visualization',
                balanced: 'Balanced',
                bottleneck: 'Bottleneck',
                taktLine: 'Takt Time Line',
                heijunkaTip: 'Balance all stations to be at the same level.',
                ...
                shift1: '1 Shift (8h/day)',
                shift2: '2 Shifts (16h/day)',
                shift3: '3 Shifts (24h/day)',
                allowOvertime: 'Allow Overtime (+25%)',
                day: 'day',
                costPerUnit: 'Cost per Unit',
                holdingCost: 'Holding Cost/Day',
                wipLimit: 'WIP Limit (unit)',
                yield: 'Yield (%)',
                raw: 'RAW',
                pushSystem: 'Push System',
                va: 'VA',
                nva: 'NVA',
                plt: 'PLT',
                electronicFlow: 'Electronic Flow',
                manualFlow: 'Manual Flow',
                safetyStock: 'Safety Stock',
                heijunka: 'Heijunka',
                kanbanPost: 'Kanban Post',
            ...
            supplyChain: {
                ...
                shortage: 'Shortage',
                issue: 'Issue',
                runPrompt: 'Run simulation to see results',
                runFirst: 'Please run the simulation first',
        ...
        fileExplorer: {
            ...
            workspace: {
                ...
                saveClipAsProject: 'Save Clip as Project',
                cuttingVideo: 'Cutting video segment...'
            },
            yamazumi: {
                title: 'Workload Balance Visualization',
                subtitle: 'Visualize and balance operator workload vs Takt Time',
                ...
                kaizenSim: 'Kaizen Sim',
                ecrsSimMode: 'ECRS Simulation Mode',
                eliminateWaste: 'Eliminate Waste',
                eliminateWasteDesc: 'Remove all Waste (Red) blocks',
    ...
    id: {
        ...
        common: {
            ...
            front: 'Depan',
            back: 'Belakang',
            noVideo: 'Peringatan: Video belum dimuat!',
            noElements: 'Peringatan: Tidak ada elemen!',
            selectTwo: 'Pilih tepat 2 elemen.',
            noActiveProject: 'Belum ada proyek aktif',
            cancel: 'Batal',
            confirm: 'Konfirmasi'
        },
        fileExplorer: {
            ...
            api: 'API',
            root: 'Root',
            search: 'Cari file dan folder...',
            empty: 'Item tidak ditemukan',
            deleteConfirm: 'Apakah Anda yakin ingin menghapus ini?',
            storageUsed: 'Penyimpanan Digunakan Total',
            newFolder: 'Folder Baru',
            mainWorkspace: 'Workspace Utama',
            tmStudio: 'TM Studio',
            elements: 'Elemen',
            rearrangeAction: 'Atur Ulang',
        ...
        header: {
            ...
            swcs: 'Lembar Standar Kerja (Dhyho-ka)',
            multiAxial: 'Analisis Multi-Aksial',
            video: 'Video',
            aiProcess: 'Proses AI',
        ...
        vsm: {
            ...
            toolbox: {
                ...
                push: 'Push',
                informationFlow: 'ALUR INFORMASI',
                productionControl: 'Production Control',
                heijunka: 'Heijunka',
                kanbanPost: 'Kanban Post',
            ...
            ai: {
                ...
                modeReplace: 'Ganti Semua',
                modeMerge: 'Gabung',
                generateButton: 'Generate AI',
                examplesButton: 'Contoh',
            ...
            analysis: {
                ...
                feasible: 'LAYAK (FEASIBLE)',
                impossible: 'TIDAK MUNGKIN (IMPOSSIBLE)',
                ...
                capacityDemandTitle: 'Kapasitas vs Permintaan (Grafik Yamazumi)',
                outputCapacity: 'Kapasitas Output',
                targetDemand: 'Target Permintaan',
                nodeInventoryStatus: 'Status Inventori Node',
                tableName: 'Node',
                tableCt: 'CT (dtk)',
                tablePcsHr: 'Pcs/Jam',
                tableShift: 'Shift',
                tableOutput: 'Output',
                tableLoadHours: 'Jam (Load)',
                tableBalance: 'Balance',
                tableStatus: 'Status',
                exportReport: 'Ekspor Laporan',
                noTimelineData: 'Tidak ada data timeline tersedia.',
            ...
            pcsPerHour: 'Pcs per Jam'
        },
        complianceDashboard: {
            title: 'Dashboard Kepatuhan Real-time',
            activeStations: 'Stasiun Aktif',
            mismatchDetected: 'KETIDAKSESUAIAN URUTAN TERDETEKSI',
            standby: 'Standby',
            ...
            ng: 'NG',
            ok: 'OK',
            sequenceMismatchLabel: 'Urutan Tidak Sesuai',
            processCompliant: 'Proses Patuh',
            cycleCount: 'Jumlah Siklus',
            recentEvents: 'Kejadian Terakhir',
            duration: 'Durasi',
            workSequence: 'Urutan Kerja',
            stopMonitoring: 'Hentikan Monitoring',
            startMonitoring: 'Mulai Monitoring',
            backToGrid: 'Kembali ke Grid',
            addNewStation: 'Tambah Stasiun Baru',
            configureCamera: 'Konfigurasi Kamera IP atau Stream',
            overlayOn: 'Overlay ON',
            overlayOff: 'Overlay OFF',
            initializing: 'Menginisialisasi...',
            loadingEngine: 'Memuat Multi-Camera Engine...',
            hideOverlay: 'Sembunyikan Overlay',
            showOverlay: 'Tampilkan Overlay',
            switchFocus: 'Beralih ke Tampilan Fokus',
            switchGrid: 'Beralih ke Tampilan Grid',
            addCamera: 'Tambah Kamera',
            configureStation: 'Konfigurasi Stasiun',
            stationName: 'Nama Stasiun',
            stationNamePlaceholder: 'contoh: Lini Perakitan 1',
            cameraType: 'Tipe Kamera',
            mjpegOption: 'IP Camera / Stream (MJPEG/HTTP)',
            streamUrl: 'URL Stream',
            streamUrlPlaceholder: 'http://192.168.1.50/mjpeg',
            complianceModel: 'Model Kepatuhan',
            selectModel: '-- Pilih Model --',
            saveConfiguration: 'Simpan Konfigurasi',
            configuredStations: 'Stasiun Terkonfigurasi',
            deleteStation: 'Hapus Stasiun'
        },
        ergoCopilot: {
            title: 'Ergo Copilot',
            uploadVideo: 'Upload Video',
            analysisMode: 'Mode Analisis',
            ergoStressTimeline: 'Timeline Stress Ergonomis',
            digitalTwinAnalysis: 'Analisis Digital Twin 3D',
            riskConfidence: 'Keyakinan Risiko',
            finalScore: 'Skor {0} Akhir',
            riskLevel: 'Tingkat Risiko',
            targetRwl: 'Target RWL',
            liftingParameters: 'Parameter Pengangkatan',
            loadWeight: 'Berat Beban (kg)',
            frequency: 'Frekuensi (angkat/menit)',
            hDistance: 'Jarak H (cm)',
            vDistance: 'Jarak V (cm)',
            improvementPlan: 'Rencana Perbaikan',
            generateReport: 'Buat Laporan Lengkap',
            uploadPrompt: 'Upload video pekerja untuk memulai analisis',
            highStressAt: 'Stress Tinggi @ {0}s',
            standby: 'Standby',
            engineering: 'Teknik',
            ergonomic: 'Ergonomis',
            administrative: 'Administratif',
            recom1: 'Kurangi puntiran batang tubuh dengan mengatur ulang tata letak part.',
            recom2: 'Pasang kursi yang dapat disesuaikan ketinggiannya untuk mengurangi stres tubuh bagian bawah.',
            recom3: 'Terapkan rotasi pekerja setiap 2 jam.',
        ...
        common: {
            ...
            alignLeft: 'Rata Kiri',
            alignTop: 'Rata Atas',
            exportAsPng: 'Ekspor sebagai PNG',
            color: 'Warna',
            normal: 'Normal'
        },
        categories: {
        ...
        project: {
            ...
            folderOptional: 'Folder (Opsional)',
            rootNoFolder: 'Root (Tanpa Folder)',
            videoSelected: 'Video Terpilih'
        },
        measurement: {
        ...
        landing: {
            ...
            hero: {
                ...
                ctaDownload: 'Unduh untuk Desktop (.exe)',
                ctaCloud: 'Akses Cloud',
                ctaTrial: 'Mulai Uji Coba 30 Menit'
            },
            solutions: {
            ...
            faq: {
                ...
                q3: {
                    ...
                    a: 'Tidak. Mavi bekerja dengan file video standar apa pun (MP4, WEBM) atau input IP Camera. Tidak diperlukan sensor mahal.'
                }
            },
            cta: {
            ...
            request: {
                title: 'Minta Kunci Lisensi',
                desc: 'Butuh lisensi profesional untuk organisasi Anda? Kirimkan permintaan dan administrator kami akan kembali kepada Anda dengan kuncinya.',
                benefit1: 'Akses seumur hidup ke semua fitur',
                benefit2: 'Dukungan prioritas dan pembaruan',
                deviceId: 'ID Perangkat (Kunci Perangkat Keras)',
                email: 'Alamat Email',
                notes: 'Catatan (Opsional)',
                notesPlaceholder: 'Ceritakan tentang organisasi Anda...',
                submit: 'Kirim Permintaan',
                sending: 'Mengirim...',
                successTitle: 'Permintaan Terkirim!',
                successDesc: 'Tim kami akan meninjau permintaan Anda dan mengirimkan kunci lisensi ke email Anda.',
                offlineTitle: 'Permintaan Tersimpan!',
                offlineDesc: 'Koneksi gagal. Permintaan disimpan secara lokal di komputer ini. Harap beri tahu admin secara manual atau coba lagi di browser lain.',
                back: 'Kembali'
            }
        },
        sensei: {
        ...
        videoWorkspace: {
            ...
            uploadVideo: 'Upload Video',
            uploadOrIP: 'Upload video atau gunakan IP Camera',
            enterURL: 'Masukkan URL Stream (rtsp/http)',
            connecting: 'Menghubungkan...',
            dragDrop: 'Drag & drop video atau klik untuk memilih',
            ...
            duration: 'Durasi',
            noVideo: 'Belum ada video dimuat',
            loading: 'Memuat video...',
            error: 'Error memuat video',
            cancel: 'Batal',
            ...
            size: 'Ukuran',
            clearDrawings: 'Hapus Semua Gambar',
            dragToResize: 'Tarik untuk mengubah ukuran',
        ...
        elementEditor: {
            ...
            normalTime: 'NT (s)',
            standardTime: 'ST (s)',
            emptyElements: 'Belum ada elemen. Mulai pengukuran untuk menambahkan elemen.',
            noFilterMatch: 'Tidak ada elemen yang sesuai dengan filter.',
            ...
            errors: {
                positiveTimes: 'Waktu Start dan Finish harus berupa angka positif.',
                startLessFinish: 'Waktu Start harus lebih kecil dari waktu Finish.',
                totalSplitExceeds: 'Total waktu breakdown tidak boleh melebihi durasi elemen.'
            },
            ratingSpeed: 'Kecepatan Rating',
            stopTracking: 'Hentikan Tracking {{type}}',
            startTracking: 'Mulai Tracking {{type}}',
            quickModeHint: 'Mode Cepat Aktif: Tekan <kbd>M</kbd> untuk mulai/akhir pengukuran. Nama elemen otomatis.',
            elements: 'Elemen',
            cycles: 'Cycle',
            ...
            sortCycle: 'Siklus',
            sortDuration: 'Durasi (Terbesar)',
            sortName: 'Nama (A-Z)',
            selectOption: '-- Pilih --',
            total: 'Total',
            splitTimePrompt: 'Masukkan waktu split (antara {{start}}s - {{end}}s):',
            invalidSplitTime: 'Waktu split tidak valid! Harus berada di antara waktu mulai dan selesai elemen.',
            toggleRatingSpeed: 'Aktifkan Kecepatan Berdasarkan Rating',
            zoomLevelTitle: 'Level Zoom'
        },
        timeline: {
            title: 'Statistik Timeline',
            totalTime: 'Total Waktu',
            vaRatio: 'VA Ratio',
            waste: 'Waste',
            bottleneck: 'Bottleneck Terdeteksi',
            noData: 'Tidak ada data',
            categoryBreakdown: 'Breakdown Kategori',
            zoomIn: 'Perbesar',
            zoomOut: 'Perkecil',
            toggleGrid: 'Tampilkan/Sembunyikan Garis',
            grid: 'Garis',
            standard: 'Standar',
            vsm: 'VSM',
            compact: 'Kompak'
        ...
        yamazumi: {
            ...
            subtitle: 'Analisis Keseimbangan Beban Kerja',
            operator: 'Operator',
            station: 'Stasiun',
            taktTime: 'Takt Time',
            ...
            showTaktLine: 'Tampilkan Garis Takt',
        ...
        vsm: {
            ...
            wizard: {
                ...
                materialSource: 'Sumber Material Pelanggan',
                production: 'Produksi',
            ...
            analysis: {
                ...
                epeiDesc: 'Tambahkan Customer (Demand) dan Proses untuk menghitung EPEI.',
                ...
                yield: 'Yield (%)',
                noAnalysisData: 'Tidak ada data proses untuk analisis',
                raw: 'RAW',
        ...
        therblig: {
            title: 'Analisis Therblig',
            subtitle: '18 Gerakan Dasar',
            motionType: 'Tipe Gerakan',
            frequency: 'Frekuensi',
            totalTime: 'Total Waktu',
        ...
        waste: {
            title: 'Eliminasi Waste',
            subtitle: '7 Waste (Muda)',
            transport: 'Transport',
            inventory: 'Inventory',
            motion: 'Motion',
            waiting: 'Waiting',
            ...
            analyze: 'Analisis',
            eliminate: 'Eliminasi',
            noWaste: 'Tidak ada waste teridentifikasi',
            wasteFound: 'Waste ditemukan'
        },
        statistics: {
        ...
        manual: {
            ...
            noDocNumber: 'Tanpa No. Dokumen',
            scanForMobile: 'Scan untuk Akses Digital',
        ...
        swcs: {
            title: 'Lembar Kombinasi Kerja Standar',
            subtitle: 'Bagan Manusia-Mesin',
            projects: 'Proyek',
            loadManual: 'Muat Data Manual',
            saveManual: 'Simpan Data Manual',
            exportPdf: 'Ekspor PDF',
            exportExcel: 'Ekspor Excel',
            importExcel: 'Impor Excel',
            tpsAnalysis: 'Analisis TPS',
            cycleTime: 'Cycle Time',
            capacity: 'Kapasitas',
            vaTime: 'Waktu VA',
            nvaTime: 'Waktu NVA',
            ...
            legend: {
                manual: 'Manual (Solid)',
                auto: 'Auto (Putus-putus)',
                walk: 'Jalan (Gelombang)'
            },
            table: {
                no: 'No',
                elementName: 'Nama Elemen',
            ...
            noData: 'Tidak Ada Data',
            noDataDescProject: 'Pilih proyek dengan data atau beralih ke Mode Manual.',
            noDataDescManual: 'Tambahkan elemen kerja pada tabel untuk memvisualisasikan data.'
        },
        workspace: {
            ...
            confirmDelete: 'Hapus proyek ini?'
        },
        fileExplorer: {
            title: 'File Explorer',
            ...
            bestWorst: 'Best vs Worst',
            rearrangement: 'Susun Ulang',
            waste: 'Eliminasi Waste',
            models: 'Model',
            api: 'API',
            root: 'Akar',
            search: 'Cari...',
            empty: 'Tidak ada item ditemukan',
            empty: 'Tidak ada item ditemukan',
            deleteConfirm: 'Hapus item terpilih?',
            recent: 'Terbaru',
            favorites: 'Favorit'
        },
        settings: {
        ...
        rearrangement: {
            title: 'Susun Ulang',
            subtitle: 'Toolbox Optimasi',
            projects: 'Proyek',
            saveOrder: 'Simpan Urutan',
            autoArrange: 'Atur Otomatis',
            shortest: 'Terpendek',
            longest: 'Terlama',
            jointSelection: 'Gabungan Selection',
            mergeHud: 'Menggabungkan #{0} dan #{1}',
            simulationPreview: 'Preview Simulasi',
            hudOn: 'HUD ON',
            hudOff: 'HUD OFF',
            liveSimulation: 'SIMULASI LIVE',
            startPreview: 'Mulai Preview',
            stopSimulation: 'Hentikan Simulasi',
            selectProject: 'Pilih Proyek',
            selectProjectSub: 'Pilih proyek dengan data hasil ukur',
            noReadyVideo: 'Tidak ada video yang siap',
            loadInstruction: 'Pilih proyek dari menu untuk memuat video simulasi',
            noProjects: 'Tidak ada proyek hasil ukur ditemukan'
        },
        swcs: {
            title: 'Standard Work Combination Sheet',
            subtitle: 'Visualisasi Standar Kerja',
            projects: 'Proyek',
            manual: 'Manual',
            exportPdf: 'Ekspor PDF',
            exportExcel: 'Ekspor Excel',
            importExcel: 'Impor Excel',
            saveProject: 'Simpan ke Proyek',
            loadManual: 'Muat Manual (JSON)',
            saveManual: 'Simpan Manual (JSON)',
            zoom: 'Zoom',
            buffer: 'Buffer',
            tpsAnalysis: 'Analisis TPS',
            cycleTime: 'Cycle Time',
            ...
            emptyProject: 'Pilih proyek yang memiliki data atau beralih ke Mode Manual.',
            emptyManual: 'Tambahkan elemen kerja pada tabel di sebelah kiri.',
            header: {
                partName: 'Nama Part',
                partNo: 'No Part',
                process: 'Proses',
        ...
        standardWorkLayout: {
            title: 'Tata Letak Standar Kerja',
            subtitle: 'Visualisasi Tata Letak Stasiun Kerja',
            projects: 'Proyek',
            saveProject: 'Simpan ke Proyek',
            exportPdf: 'Ekspor PDF',
            header: {
            ...
            empty: {
                title: 'Tidak ada data tata letak',
                desc: 'Pilih proyek untuk mulai mendesain tata letak standar kerja.'
            }
        },
        analysisDashboard: {
            title: 'Ringkasan Analisis',
            emptyState: 'Belum ada data untuk ditampilkan. Tambahkan measurements terlebih dahulu atau gunakan Tab Safety/QC.',
            openSafety: '🛡️ Buka Safety AI',
            openQC: 'Visual QC (TM)',
            openVideoIntel: '📹 Gemini Video Intelligence',
            kaizenReport: 'Laporan Kaizen 1-Klik',
            totalTime: 'Total Waktu',
            ...
            productivityIndex: 'Indeks Produktivitas',
            categoryDist: 'Distribusi Kategori',
            topElements: 'Top 10 Elemen (Durasi)',
            categoryBreakdown: 'Breakdown per Kategori',
            elementsCount: 'elemen',
            swcs: 'Lembar Kombinasi Kerja Standar'
        },
        senseiKnowledge: {
            intro: 'MAVi (Motion Analysis Video Intelligence) adalah aplikasi analisis video untuk Industrial Engineering.',
            featuresHeader: 'FITUR-FITUR UTAMA:',
            navHeader: 'MENU NAVIGASI:',
            navItems: [
            ...
            tipsHeader: 'TIPS PENGGUNAAN:',
            tips: [
                '1. Untuk pemula: Mulai dari Video Workspace, upload video, lalu gunakan Element Editor',
                '2. Gunakan keyboard shortcuts (S/E) untuk mempermudah measurement',
        ...
        maviClassData: {
            glossary: {
                therblig: { term: 'Therblig', def: 'Unit dasar gerakan dalam motion study, terdiri dari 18 elemen gerakan.' },
                cycleTime: { term: 'Cycle Time', def: 'Waktu yang diperlukan untuk menyelesaikan satu siklus operasi.' },
                taktTime: { term: 'Takt Time', def: 'Waktu yang diperlukan untuk memproduksi satu unit produk agar memenuhi demand pelanggan.' },
                reba: { term: 'REBA', def: 'metode ergonomi untuk mengevaluasi risiko postur kerja seluruh tubuh.' },
                rula: { term: 'RULA', def: 'metode ergonomi untuk menilai risiko gangguan pada tubuh bagian atas.' },
                vsm: { term: 'VSM', def: 'Alat visual untuk memetakan aliran material dan informasi.' },
                yamazumi: { term: 'Yamazumi', def: 'Chart visual berbentuk stacked bar untuk distribusi beban kerja.' },
                swcs: { term: 'SWCS', def: 'Dokumen standar kombinasi kerja manual, mesin, dan jalan.' },
                muda: { term: 'Muda', def: '7 pemborosan dalam Lean (TIMWOOD).' },
                vaNva: { term: 'VA/NVA', def: 'Klasifikasi aktivitas berdasarkan nilai tambah.' },
                mediaPipe: { term: 'MediaPipe', def: 'Framework ML untuk mendeteksi pose tubuh secara real-time.' },
                dtw: { term: 'DTW', def: 'Algoritma untuk mengukur kesamaan antara dua sequences.' },
                fsm: { term: 'FSM', def: 'Model komputasi dengan states terbatas dan transisi.' },
                lineBalancing: { term: 'Line Balancing', def: 'Proses mendistribusikan beban kerja secara merata.' },
                bottleneck: { term: 'Bottleneck', def: 'Proses dengan cycle time terpanjang yang membatasi output.' },
                standardTime: { term: 'Standard Time', def: 'Waktu penyelesaian task oleh operator terlatih pada kondisi normal.' },
                allowance: { term: 'Allowance', def: 'Faktor tambahan untuk kebutuhan personal dan delay.' },
                normalTime: { term: 'Normal Time', def: 'Observed time yang disesuaikan dengan rating factor.' },
                ratingFactor: { term: 'Rating Factor', def: 'Perbandingan kecepatan kerja operator dengan standar.' },
                workSampling: { term: 'Work Sampling', def: 'Teknik pengukuran kerja dengan sampel observasi random.' }
            },
            badges: {
                firstLesson: { name: 'Langkah Awal', desc: 'Selesaikan lesson pertama' },
                quickLearner: { name: 'Quick Learner', desc: 'Selesaikan 1 modul penuh' },
                dedicated: { name: 'Siswa Berdedikasi', desc: 'Selesaikan 3 modul' },
                knowledgeSeeker: { name: 'Pencari Ilmu', desc: 'Selesaikan 6 modul' },
                master: { name: 'MAVi Master', desc: 'Selesaikan semua modul' },
                quizTaker: { name: 'Quiz Taker', desc: 'Selesaikan quiz pertama' },
                perfectScore: { name: 'Perfect Score', desc: 'Dapatkan skor 100% di quiz' },
                quizChamp: { name: 'Quiz Champion', desc: 'Lulus semua quiz' },
                consistent: { name: 'Konsisten', desc: 'Belajar 3 hari berturut-turut' },
                weekWarrior: { name: 'Pejuang Mingguan', desc: 'Belajar 7 hari berturut-turut' },
                noteTaker: { name: 'Pencatat', desc: 'Buat 5 catatan' },
                explorer: { name: 'Penjelajah', desc: 'Kunjungi semua tab' }
            },
            syllabus: {
                title: 'MAVi Class - Industrial Engineering Video Analysis',
                desc: 'Kurikulum komprehensif untuk menguasai analisis video dalam IE menggunakan MAVi.',
                instructorName: 'MAVi Sensei (AI)',
                instructorRole: 'Asisten Pengajar AI',
                prereq1: 'Pemahaman dasar tentang proses manufaktur',
                prereq2: 'Familiar dengan komputer dan browser modern',
                prereq3: 'Tidak perlu pengalaman programming',
                outcome1: 'Mampu melakukan Time & Motion Study menggunakan video',
                outcome2: 'Dapat mengidentifikasi dan mengeliminasi waste',
                outcome3: 'Mampu membuat Work Instruction dan SOP dari video',
                outcome4: 'Dapat menggunakan AI untuk analisis otomatis',
                outcome5: 'Mampu setup real-time compliance monitoring'
            },
            levels: {
                beginner: 'Pemula',
                apprentice: 'Magang',
        ...
        machineLearning: {
            ...
            subtitle: 'Integrasi Google Teachable Machine untuk deteksi gerakan dan anomali',
            videoSlicer: 'Video Slicer & Dataset Builder',
            videoSlicerDesc: 'Ekstrak segmen video untuk training dataset AI (Teachable Machine / CVAT.ai)',
            captureClip: 'Capture Clip untuk Dataset',
            datasetGallery: 'Galeri Dataset',
            extractToZip: 'Ekstrak Gambar ke ZIP',
            extracting: 'Mengekstrak...',
            deleteClip: 'Hapus Clip',
            previewStart: 'Preview Mulai',
            previewEnd: 'Preview Selesai',
            previewSlice: 'Pratinjau Slice',
            noClips: 'Belum ada klip yang dicapture',
            galleryDescription: 'Capture klip dari video untuk membangun dataset khusus Anda.',
            downloadClip: 'Unduh Klip Video',
            originalVideoRequired: 'File video asli diperlukan untuk ekstraksi. Silakan upload ulang atau pastikan video dimuat sebagai File.',
            selectSegment: 'Pilih Segmen (Detik)',
            useTeachableMachine: 'Gunakan Teachable Machine',
            startAnalysis: 'Mulai Analisis',
            stopAnalysis: 'Hentikan Analisis',
            consistencyTrend: 'Tren Konsistensi'
        },
        bestWorst: {
            title: 'Analisis Cycle Best vs Worst',
            selectProject: 'Pilih Project (Min 2)',
            noProjects: 'Belum ada project tersimpan.',
            selectMin2: 'Pilih minimal 2 project untuk melihat analisis.',
            loading: 'Memuat analisis...',
            bestCycle: 'Cycle Terbaik',
            worstCycle: 'Cycle Terburuk',
            potentialSavings: 'Potensi Penghematan',
            improvement: 'peningkatan',
            ranking: 'Ranking Semua Cycle',
            comparison: 'Perbandingan Elemen-ke-Elemen',
            elementName: 'Nama Elemen',
            category: 'Kategori',
            bestTime: 'Terbaik (s)',
            worstTime: 'Terburuk (s)',
            difference: 'Selisih (s)',
            diffPct: 'Selisih (%)',
            videoSideBySide: 'Perbandingan Video Berdampingan',
            syncControls: 'Kontrol Sinkron',
            aiAnalysis: 'Analisis AI',
            selectLeft: 'Pilih Projek Kiri...',
            selectRight: 'Pilih Projek Kanan...',
            best: 'TERBAIK',
            worst: 'TERBURUK'
        },
        spaghettiChart: {
            title: 'Spaghetti Chart Analysis',
            subtitle: 'Simulasi aliran kerja & identifikasi pemborosan gerakan',
            projects: 'Pilih Project...',
            saveProject: 'Simpan Analisis',
            header: {
                partName: 'Nama Part',
                partNo: 'No Part',
                machine: 'Mesin',
            ...
            toolbox: {
                station: 'Stasiun Operator',
                material: 'Kontrol Inventaris',
                machine: 'Unit Pemrosesan',
                qc: 'Inspeksi Kualitas',
                parts: 'Penyimpanan Buffer',
                clear: 'Hapus Kanvas'
            },
            simulation: {
                run: 'Mulai Simulasi',
                ...
                cycleTime: 'Cycle Time',
                efficiency: 'Efisiensi',
                aiOptimize: 'Optimasi AI',
                optimizing: 'Sedang Mengoptimasi...',
                scanComplete: 'Scan Selesai',
                wasteDetected: 'Pemborosan Terdeteksi',
                taktTime: 'Takt Time',
                manualTime: 'Waktu Manual',
                machineTime: 'Waktu Mesin',
                walkingTime: 'Waktu Jalan',
                breakdown: 'Breakdown',
                taktViolation: 'Pelanggaran Takt!',
                uShapeRecommendation: 'Rekomendasi U-Shape'
            },
            helpGuide: {
                title: 'Panduan Diagram Spageti',
                subtitle: 'Cara menggunakan sistem optimasi Lean',
                step1: 'Drag & Drop alat dari toolbox kiri ke kanvas.',
                step2: 'Hubungkan node untuk membuat alur kerja.',
                step3: 'Gunakan AI Optimize untuk meminimalkan jarak.',
                step4: 'Gunakan U-Shape untuk sel manufaktur terbaik.',
                step5: 'Klik node untuk mengedit waktu Manual/Mesin.'
            },
            aiChat: {
                title: 'Mavi Lean Assistant',
                subtitle: 'Pakar Toyota Production System',
                placeholder: 'Tanyakan tentang optimasi layout...',
                systemPrompt: 'Anda adalah pakar Toyota Production System (TPS). Bantu user mengoptimalkan diagram spageti mereka. Berikan saran tentang pengurangan berjalan, keseimbangan operator, dan tata letak sel.'
            },
            empty: {
                title: 'Tidak ada data Spageti',
                desc: 'Pilih proyek untuk mulai analisis diagram spageti.'
            }
        },
    },
    en: {
